...
const scenes: Record<string, Line[]> = {
  Init: [
    ...
    { type: 'output', text: 'Created .claude/agents/ (13 agent definitions)', delay: 200 },
    { type: 'output', text: 'Created .sniper/protocols/ (7 protocols)', delay: 200 },
    { type: 'output', text: 'Created .sniper/templates/ (15 templates)', delay: 200 },
  ...
  Flow: [
    ...
    { type: 'heading', text: 'Phase 1/7: Discover', delay: 300 },
  ...
  Implement: [
    ...
    { type: 'heading', text: 'Phase 5/7: Implement', delay: 400 },
